...
setLoading(false)
  ...
  setLoading(false)
  toast.error("Poroduct not added!")
          ...
          <Col lg="12">
          {
            ...
            <Form onSubmit={addProduct}>
              <FormGroup className="form__group">
                ...
                <input type="text" placeholder="DoubleSofa"
              ...
              <FormGroup className="form__group">
                ...
                <input type="text" placeholder="Descriotion.."
              ...
              <FormGroup className="form__group w-50">
               <span>Price</span>
               <input type='number' placeholder='Rs 20,0000'
